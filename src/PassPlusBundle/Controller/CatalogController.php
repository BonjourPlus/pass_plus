...
class CatalogController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $catalogs = $em->getRepository('PassPlusBundle:Catalog')->findAll();
    ...
    {
        $catalog = new Catalog();
        $form = $this->createForm('PassPlusBundle\Form\CatalogType', $catalog);
    ...
    {
        $deleteForm = $this->createDeleteForm($catalog);
        $editForm = $this->createForm('PassPlusBundle\Form\CatalogType', $catalog);
